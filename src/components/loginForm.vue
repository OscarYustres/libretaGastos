        ...
        <div class="form-group">
            ...
            <div class="cols-sm-10">
              <div class="input-group">
                ...
                <input type="password" class="form-control" placeholder='Ingrese la contraseña' v-model='password' />
              </div>
            </div>
          </div>
        <div class="form-group ">
...
export default {
  ...
  methods: {
    manejoClick: function () {
      var email=''
      this.firebase.auth().createUserWithEmailAndPassword(this.correo, this.password)
      .then((response) => {
    ...
    ingresar: function() {
      this.firebase.auth().signInWithEmailAndPassword(this.correo, this.password)
      .then((response) => {
